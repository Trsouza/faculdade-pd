...
// @Accept json
// @Produce json
// @Param disciplinaMatricula body models.DisciplinaMatricula true "disciplinaMatricula"
...
func CriarDisciplinaMatricula(c *gin.Context) {
	...
	disciplinaMatricula.DataMatricula = time.Now()
	...
	err = db.Create(&disciplinaMatricula).Error
	if err != nil {
		c.JSON(400, gin.H{
	...
	c.JSON(201, disciplinaMatricula)
}
...
func EditarDisciplinaMatricula(c *gin.Context) {
	...
	err = db.Save(&disciplinaMatricula).Error
	if err != nil {
		c.JSON(400, gin.H{
